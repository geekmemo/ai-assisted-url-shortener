...
def client(tmp_path, monkeypatch):
    ...
    (config, database, models, rate_limiter, main) is reloaded together so a
    module added later can't be silently left stale, the way app.rate_limiter
    was before this fixture existed.
    """
